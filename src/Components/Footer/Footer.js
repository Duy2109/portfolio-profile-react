...
function Footer() {
    ...
    <div className="container footer-section" id="footersection">
        <div className="row">
          <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6">
              <a href="https://facebook.com" target="_blank" rel="noopener">
              <img alt="Facebook Open Source"
             ...
             <p className="sta_content">Copyright © 2023 Meta Platforms, Inc.</p>
          </div>

          <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6">
            <div className="icon_css">
              <a href="https://github.com/Duy2109"  className="a_styles">
                <AiFillGithub size={40} className="icon_styles" />
              </a>
              <a href="https://google.com.vn"  className="a_styles">
                <AiFillTwitterCircle size={40} className="icon_styles"/>
              </a>

              <a href="https://www.facebook.com"   className="a_styles">
                <BsFacebook size={35} className="icon_styles" />
              </a>
              <a href="https://www.tiktok.com/@simiduser"   className="a_styles">
                <FaTiktok size={35} className="icon_styles"/>
              </a>
            </div>
          </div>
        </div>
